...
import ApprovedWithdrawalDetail from "./ApprovedWithdrawalDetails";
...
const fetchApprovedWithdrawals = async ({ page, search, fromDate, toDate }) => {
    try {
