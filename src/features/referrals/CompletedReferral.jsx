...
import ViewDetailCompletedReferral from "./ViewDetailCompletedReferral";

const fetchCompletedReferrals = async (page, search, fromDate, toDate) => {
    try {
...
export default function CompletedReferral() {
